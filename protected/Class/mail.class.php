...
function sendmail($to, $subject = 'No subject', $body) {
    ...
    $smtp_acc = "zhxsglhq@126.com";        //Smtp认证的用户名，类似fuweng@im286.com，或者fuweng
    $smtp_pass="ysdbyorjubqghyct";              //Smtp认证的密码，一般等同pop3密码
    $smtp_host="smtp.126.com";    //SMTP服务器地址，类似 smtp.tom.com
    $from="zhxsglhq@126.com";              //发信人Email地址，你的发信信箱地址
